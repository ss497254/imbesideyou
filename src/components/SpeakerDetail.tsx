...
export const SpeakerDetail = ({ img, title, desc }: any) => {
    return (
        <div className="flex mb-12 max-w-[500px]">
            <div>
                <div className="relative z-10 mb-6 rounded-full min-w-[175px]">
                    <img
                        src={img}
                        alt="image"
                        className="w-44 h-44 m-2 rounded-full hover:scale-110 transition duration-500"
                    />
                    <DottedBackground />
                ...
                <div className="text-center mb-6">
                    ...
                    <div className="flex items-center justify-center">
                        <a
                            href="#"
                            className="mx-2 flex h-8 w-8 items-center hover:text-blue-500 rounded-full hover:bg-gray-100 justify-center text-[#cdced6] hover:text-primary"
                        >
                            <svg
                                width="10"
                                height="18"
                        ...
                        <a
                            href="#"
                            className="mx-2 flex h-8 w-8 items-center hover:text-sky-400 rounded-full hover:bg-gray-100 justify-center text-[#cdced6] hover:text-primary"
                        >
                            <svg
                                width="18"
                                height="14"
                        ...
                        <a
                            href="#"
                            className="mx-2 flex h-8 w-8 items-center hover:text-pink-400 rounded-full hover:bg-gray-100 justify-center text-[#cdced6] hover:text-primary"
                        >
                            <svg
                                width="18"
                                height="18"
            ...
            <div className="mb-5 text-sm text-body-color flex flex-col gap-3 px-8 text-justify">
